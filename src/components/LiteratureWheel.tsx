...
}, [pressing, numCabins, accelWhilePress, maxAngVel]);
...
const counter = -(angle * 180 / Math.PI);
...
```
      <g>
        <path d="M390 560 L420 280 L438 280 L408 560 Z" fill="#6b4423" opacity="0.95" />
        <path d="M510 560 L480 280 L462 280 L492 560 Z" fill="#6b4423" opacity="0.95" />
